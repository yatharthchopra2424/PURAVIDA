...
export default function ProductModal({
  ...
  function update<K extends keyof typeof form>(key: K, value: (typeof form)[K]) {
    setForm((f) => {
      ...
      // Slug is derived from name. Deriving it here — in the event that
      // changes the name — rather than in an effect avoids a cascading
      // render, and keeps the two fields in sync in a single update.
